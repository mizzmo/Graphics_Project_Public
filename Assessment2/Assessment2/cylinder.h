...
std::vector<GLfloat> form_cylinder(int num_segments, float top_radius, float bottom_radius, float height, float opacity, int& out_vertex_count) {
    ...
    for (int i = 0; i < num_segments; i++) {
        ...
        glm::vec3 bottomColour = glm::vec3(0.0f, 0.2f, 0.4f); 
        glm::vec3 topColour = glm::vec3(0.4f, 0.8f, 0.6f);    
        ...
        auto interpolateColour = [&](float t) {
            return bottomColour + t * (topColour - bottomColour);
        };
        ...
        glm::vec3 color_bottom = interpolateColour(t_bottom);
        ...
        glm::vec3 color_top = interpolateColour(t_top);
        ...
        glm::vec3 color_bottom_right = interpolateColour(t_bottom_right);
        ...
        glm::vec3 color_top_right = interpolateColour(t_top_right);
